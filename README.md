...
## Project Structure
    ...
    ├── crowdbotics_dashboa_34429  # Django project configurations
...
1. Clone this repo and `cd crowdbotics_dashboa_34429`
...
2. Clone this repo and `cd crowdbotics_dashboa_34429`
